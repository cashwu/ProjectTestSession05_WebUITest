...
namespace Lab.WebApplicationUITests
{
    ...
    public class TestCase04
    {
        ...
        [TestMethod]
        public void TheCase04Test()
        {
            driver.Navigate().GoToUrl(baseURL);
            new SelectElement(driver.FindElement(By.Id("Companys"))).SelectByText("大同資訊");
            driver.FindElement(By.Id("ButtonSubmit")).Click();
            Assert.AreEqual("三重綜合體育場-司令台左側", driver.FindElement(By.CssSelector("td")).Text);
        }
